# Generated by Django 2.1.5 on 2019-01-12 19:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_keywords', models.TextField(max_length=255, null=True, verbose_name='Keywords')),
                ('description', models.TextField(max_length=255, null=True, verbose_name='Описание категории')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_description', models.CharField(max_length=255, null=True, verbose_name='Описание страницы')),
                ('page_keywords', models.TextField(max_length=255, null=True, verbose_name='Keywords')),
                ('description', models.TextField(max_length=255, null=True, verbose_name='Описание коллекции')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_title', models.CharField(max_length=255, null=True, verbose_name='Название страницы')),
                ('page_description', models.CharField(max_length=255, null=True, verbose_name='Описание страницы')),
                ('description', models.TextField(max_length=255, null=True, verbose_name='Описание товара')),
                ...
                ('article', models.CharField(default='', max_length=50, null=True, verbose_name='Артикул')),
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Отображать товар ?')),
                ('is_present', models.BooleanField(default=True, verbose_name='Товар в наличии ?')),
                ('is_new', models.BooleanField(default=False, verbose_name='Товар новинка ?')),
                ('is_reserved', models.BooleanField(default=False, verbose_name='Товар в резерве ?')),
                ('buys', models.IntegerField(default=0)),
                ('views', models.IntegerField(default=0)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('collection', models.ManyToManyField(blank=True, to='item.Collection', verbose_name='Коллекция')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('promo_code', models.CharField(max_length=255, null=True, verbose_name='Промокод')),
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2019, 1, 12, 19, 1, 36, 869531), verbose_name='Срок действия безлимитного кода')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_description', models.CharField(max_length=255, null=True, verbose_name='Описание страницы')),
                ('page_keywords', models.TextField(max_length=255, null=True, verbose_name='Keywords')),
                ('description', models.TextField(max_length=255, null=True, verbose_name='Описание подкатегории')),
